...
exports.addUserToGoogleGroup = addUserToGoogleGroup;
exports.removeUserFromGoogleGroup = removeUserFromGoogleGroup;
exports.isUserInGoogleGroup = isUserInGoogleGroup;
...
function getAdminClient() {
    ...
    const config = (0, config_1.getGoogleConfig)();
 ...
 */
async function addUserToGoogleGroup(userEmail) {
    try {
 ...
 * @returns Result object with success status and message
 */
async function removeUserFromGoogleGroup(userEmail) {
    try {
 ...
 */
async function isUserInGoogleGroup(userEmail) {
    try {
        const admin = getAdminClient();
